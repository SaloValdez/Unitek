 ...
 * {@link Ejercicio_N_17.OnFragmentInteractionListener} interface
 * to handle interaction events.
 */
public class Ejercicio_N_17 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_ejercicio__n_17, container, false);
    ...
    private void VerificarSuma(){
        ...
        suma = Num1 + Num2;
        if (Num3 == suma){
            mensaje.setText("La suma del 1º y 2º es igual al Numero 3");
