 ...
 * {@link Ejercicio_N_26.OnFragmentInteractionListener} interface
 * to handle interaction events.
 */
public class Ejercicio_N_26 extends Fragment {
    private EditText numero_a,numero_b,resultado_a,resultado_b;
    private Button calcular_a,calcular_b;

    private OnFragmentInteractionListener mListener;

    public Ejercicio_N_26() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_ejercicio__n_26, container, false);
    ...
    private void VerificarConDosIf(){
        ...
        if (num_a < 0){
            resultado_a.setText("Es Negativo");
        }
        if (num_a > 0){
            resultado_a.setText("Es positivo");
        }
        if (num_a ==0){
            resultado_a.setText("Es neutro");
        }
    }
    private void VerificarConUnIfElse(){
        ...
        if (num_b<0){
            resultado_b.setText("Es Negativo");
        }else if (num_b >0){
            resultado_b.setText("Es Positivo");
        }else if (num_b == 0){
            resultado_b.setText("Es Neutro");
        }
    }
